...
public class ErrorHandler {
    ...
    public ResponseEntity<ErrorDto> handleDeliveryNotFoundException(DeliveryNotFoundException exception) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(new ErrorDto("Delivery not found", exception.getMessage()));
    }
