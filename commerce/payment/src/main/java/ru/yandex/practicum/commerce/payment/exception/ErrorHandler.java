...
public class ErrorHandler {
    ...
    public ResponseEntity<ErrorDto> handlePaymentNotFoundException(PaymentNotFoundException exception) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(new ErrorDto("Payment not found", exception.getMessage()));
    }
